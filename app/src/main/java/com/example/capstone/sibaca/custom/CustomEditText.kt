package com.example.capstone.sibaca.custom
...
class CustomEditText : TextInputEditText {
    ...
    private fun init() {
        errorBackground = ContextCompat.getDrawable(context, R.drawable.background_edit_error)
        defaultBackground = ContextCompat.getDrawable(context, R.drawable.background_edit_default)
